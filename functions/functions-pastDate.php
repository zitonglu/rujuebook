 ...
 */
function rujuebook_past_date(){
    $suffix=__('前','rujuebook');
    $endtime='2419200';
    $day = __('天','rujuebook');
    $hour = __('小时','rujuebook');
    $minute = __('分钟','rujuebook');
    $second = __('秒','rujuebook');
...
add_filter('the_time', 'rujuebook_past_date');